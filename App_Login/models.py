...
#to automatically create profile or, one to one relation objects
...
#"""A custom manager to deal with emails unique as identifier"""
    def _create_user(self,email,password,**extra_fields):
#"""creates and saves a user with a given email and password field.no user name is required now!"""
        if not email:
            raise ValueError("You need to set a Valid email First!")
